            ...
            <div className="inn_container py-3 md:py-18 ">
                <div className="md:pb-6 max-w-3xl mx-auto grid grid-cols-1 md:grid-cols-2 items-center gap-3 md:gap-6">
                    <div className="text-center md:text-left">
                        <h5 className="text-2xl md:text-3xl text-white">Our customers say</h5>
                        <h3 className="text-3xl md:text-4xl text-primary font-semibold pt-2.5">Excellent</h3>
                    </div>

                    <div className="flex flex-col items-center md:items-end">
                        <h5 className="text-2xl text-white underline mb-2">
                            3.4 out of
                        </h5>
