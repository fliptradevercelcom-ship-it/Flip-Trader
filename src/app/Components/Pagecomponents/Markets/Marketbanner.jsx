  ...
  return (
    <div className="relative">
      ...
      <div className="inn_container h-full pt-[180px]  2xl:pt-[200px]">
        ...
        <div className="hidden lg:flex items-center h-[86%] absolute top-[121px] right-0 w-[25%]  z-[1]">
          <div className="relative flex flex-col items-end gap-2 2xl:gap-4 w-full">
