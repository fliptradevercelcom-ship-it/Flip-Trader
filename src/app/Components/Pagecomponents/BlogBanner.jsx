      ...
      <div className="inn_container">
        <div className="grid grid-cols-1">
          <div className="flex flex-col justify-center text-center  pt-40 pb-2 md:pb-20 lg:pt-48">
            <Title
              title={"FlipTrade Blog – Where <br/>  Traders Get Smarter"}
              color={"gradient_text"}
              ish1={true}
            />
            <div className="py-6 max-w-3xl m-auto">
              <Discription
                dispription={
                  "Explore powerful trading ideas, market analysis, and expert tips designed to help you trade faster, smarter, and more confidently."
                }
                color={"text-[#D0D0D0]"}
              />
            </div>
