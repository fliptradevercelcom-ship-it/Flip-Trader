...
const aboutFlipTradeData = [
  {
    title: "Why FlipTrade Group",
    description:
      "We built FlipTrade Group because we believe trading should not be limited to a select few. Financial markets should be open, transparent, and accessible to anyone willing to learn and grow."
  },
  {
    title: "Our Background",
    description:
      "As traders ourselves, we saw how modern technology could unlock global opportunities. FlipTrade Group was created to empower individuals with the right tools, education, and support."
  },
  {
    title: "Trust",
    description:
      "FlipTrade Group is built on transparency and reliability. We prioritize fund safety, fair pricing, and honest trading conditions with no hidden charges or misleading practices."
  },
  {
    title: "Access",
    description:
...
const stepdata = [
  ...
  },
  {
    title: "Trade & Grow",
    description:
      "Execute trades with advanced <br/> tools and grow confidently."
  }
];

export default function RagulationData() {
  ...
  const values = [
    {
      ...
      title: "Innovation",
      desc: "Cutting-edge fintech evolution."
    },
    {
      icon: <Shield className="w-6 h-6" color="white" />,
      title: "Security",
      desc: "Bank-level encryption standards."
    },
    {
      icon: <Globe className="w-6 h-6" color="white" />,
      title: "Global Access",
      desc: "Serving 50+ countries 24/7."
    },
    {
      icon: <Users className="w-6 h-6" color="white" />,
      title: "Community",
      desc: "A trusted trader ecosystem."
    },
    {
      icon: <Award className="w-6 h-6" color="white" />,
      title: "Excellence",
      desc: "Premium service, zero hidden fees."
    }
    ...
    <div className="min-h-screen bg-[#050505] text-white selection:bg-[#6a40ec]/30 font-sans">
      ...
      <div className="inn_container py-6">
        <div className="max-w-7xl m-auto flex flex-col-reverse md:grid grid-cols-2 gap-x-6 gap-y-6">
          <div className="m-auto">
            <div>
              <Title title={"CEO Massage"} color={"text-white"} />
          ...
          <div className="lg:col-span-6 h-full">
            <div className="h-full bg-white/[0.03] border border-white/10 rounded-[2.5rem] p-6 md:p-12 hover:border-[#6a40ec]/60 transition-all flex flex-col justify-center">
              ...
              <h2 className="text-4xl font-bold mt-4 mb-6">
                Building a <span className="text-[#6a40ec]">
                  Fair Trading
                </span>{" "}
                Ecosystem
              </h2>
              <p className="text-gray-400 text-lg leading-relaxed">
                At Flip Trade Group, our mission is to empower traders by
                providing secure, transparent, and technology-driven Forex
                trading solutions. We are committed to delivering fast
                execution, reliable platforms, and professional support that
            ...
            <div className="h-full bg-gradient-to-br from-[#6a40ec] to-[#b46aff] rounded-[2.5rem] p-6 md:p-12 relative overflow-hidden flex flex-col justify-between">
              ...
              <div>
                ...
                <p className="text-white/80 text-lg leading-relaxed">
                  Our vision is to become a globally recognized and trusted
                  Forex brand, setting new standards in service quality,
                  innovation, and client satisfaction while creating long-term
                  value for traders and partners worldwide.
                </p>
              </div>
      ...
      <div className="inn_container py-6 md:py-12">
        <div className="text-center">
          <Title title={"Fliptrade Group In Numbers"} color={"gradient_text"} />
        </div>
        ...
        <div className="pt-12 grid  grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-6">
          <div className="text-center">
            ...
            <p className="text-base lg:text-lg 2xl:text-[22px] text-white pt-3">
              Fliptrade is trusted by over 100,000 active traders worldwide,
              empowering them with smart tools, fast execution, and reliable
              trading conditions.
            </p>
          </div>
          ...
          <div className="text-center">
            <div>
              <Title
                ...
                color={"text-white"}
              />
              <Discription dispription={"COUNTRIES"} color={"text-white"} />
            </div>
            <p className="text-base lg:text-lg 2xl:text-[22px] text-white pt-3">
              We serve traders across more than 50 countries, building a global
              trading community supported by cutting-edge technology and local
              expertise.
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-base lg:text-lg 2xl:text-[22px] text-white pt-3">
              ...
              Fliptrade focuses on transparency, innovation, and long-term
              trader success.
            </p>
          </div>
        </div>
      ...
      <section className="py-6 md:py-12 bg-[#050505] inn_container relative">
        <div className=" md:px-6">
          <div className="text-center mb-20">
            <Title title={"The FlipTrade Pillars"} color={"text-white"} />
